...
class MultiOrganelleSegDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for org in self.organelles:
            ...
            mask_patch = T.ToTensor()(mask_patch)  # [0,1]
...
def main():
    ...
    train_ds = MultiOrganelleSegDataset(domain_path, "train", organelles, args.patch_size, args.stride)
    val_ds = MultiOrganelleSegDataset(domain_path, "val", organelles, args.patch_size, args.stride)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % 10 == 0:
            save_path = args.out_path.replace(".pth", f"_epoch{epoch}.pth")
...
python train.py --data_root data --domain multiclass --out_path ./models/multiclass/model.pth --patch_size 256 --stride 128 --batch_size 8 --epochs 20 --lr 1e-4 --device cuda

python train.py --data_root data --domain urocell_3 --out_path ./models/urocell_3/model.pth --patch_size 256 --stride 128 --batch_size 8 --epochs 20 --lr 1e-4 --device cuda
